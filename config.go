...
func NewConfig() (*Config, error) {
	cfg := &Config{
		ApiUrl:              OptionString("AMAZE_CLOUD_API_URL", AmazeApiUrl),
		ApiVersion:          OptionString("AMAZE_CLOUD_API_VERSION", AmazeApiVersion),
		AccountSid:          OptionString("AMAZE_CLOUD_ACCOUNT_SID", ""),
		AuthToken:           OptionString("AMAZE_CLOUD_AUTH_TOKEN", ""),
		ResponseContentType: OptionString("AMAZE_CLOUD_RESPONSE_TYPE", DefaultResponseContentType),
	}
